...
def draw_mouth(x1, y1, x2, y2, c):
    mouth = gr.Line(gr.Point(x1, y1), gr.Point(x2, y2))
    mouth.setWidth(20)
    mouth.setOutline(c)
    mouth.draw(window)


def draw_eye(x, y, r, c):
...
def draw_eyebrow(x1, y1, x2, y2):
    eyebrow = gr.Line(gr.Point(x1, y1), gr.Point(x2, y2))
    eyebrow.setWidth(10)
...
def draw_leg(x1, y1, x2, y2):
    leg = gr.Line(gr.Point(x1, y1), gr.Point(x2, y2))
    leg.setWidth(20)
    leg.setOutline('pink')
    leg.draw(window)
