...
def draw_creature(x,y, size):
    face2 = gr.Circle(gr.Point(x, y), size)
    face2.setFill('pink')

    eye3 = gr.Circle(gr.Point(650, 480), size/5)
    eye4 = gr.Circle(gr.Point(710, 480), size/5)
    eye3_center = gr.Circle(gr.Point(650, 480), size/20)
    eye4_center = gr.Circle(gr.Point(710, 480), size/20)
    eye3.setFill('white')
    eye4.setFill('white')
